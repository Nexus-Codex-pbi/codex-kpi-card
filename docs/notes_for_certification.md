```
Source code URL: https://github.com/Nexus-Codex-pbi/codex-kpi-card
...
1180.2.2.2 Tooltips: Hover over the visual to verify that a tooltip appears displaying the label (if bound) and other metadata. Verify that the tooltip hides on mouse leave.
